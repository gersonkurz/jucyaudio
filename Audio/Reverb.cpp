...
namespace jucyaudio::audio
{
    ...
    void Reverb::prepare(const juce::dsp::ProcessSpec& spec)
    {
        ...
        spdlog::debug("Reverb prepared: sample rate = {}, block size = {}, channels = {}",
    ...
    void Reverb::applyPendingParameters()
    {
        ...
        spdlog::trace("Reverb parameters updated: room={:.2f}, damp={:.2f}, wet={:.2f}, dry={:.2f}, width={:.2f}, freeze={}",
                     params.roomSize, params.damping, params.wetLevel, params.dryLevel, 
                     params.width, params.freezeMode > 0.5f ? "on" : "off");
    }
