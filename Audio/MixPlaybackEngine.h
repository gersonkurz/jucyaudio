...
namespace jucyaudio
{
    namespace audio
    {
        ...
        struct PlaybackTrackSource
        {
            ...
            const TrackInfo *trackInfo;
            const MixTrack *mixTrack;
            Duration_t calculatedStartTime{0}; // ATTACH-based start time
        ...
        /**
         * MixPlaybackEngine - Real-time playback engine for mix previews (ATTACH-based version)
         *
         * This class handles the real-time mixing of multiple tracks with overlaps,
         * crossfades, and envelope-based volume control. It uses the ATTACH model
         * where tracks connect via attach points rather than absolute positions.
         */
        class MixPlaybackEngine : public juce::AudioIODeviceCallback, public juce::AudioSource
        {
        public:
        ...
        private:
            ...
            MixProjectLoader *m_mixLoader{nullptr};
            std::vector<std::unique_ptr<PlaybackTrackSource>> m_trackSources;
            std::map<TrackId, Duration_t> m_trackPositions; // ATTACH-based calculated positions
