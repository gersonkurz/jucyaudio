...
namespace jucyaudio
{
    namespace ui
    {
        ...
        ExportSettingsTab::ExportSettingsTab()
        {
            ...
            // Configure labels
            for (auto *label : {&m_artistLabel, &m_albumLabel, &m_yearLabel, &m_genreLabel, &m_commentLabel})
            {
            ...
            for (auto *editor : {&m_artistEditor, &m_albumEditor, &m_yearEditor, &m_genreEditor, &m_commentEditor})
            {
