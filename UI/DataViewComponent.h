...
namespace jucyaudio
{
    namespace ui
    {
            ...
            void paint(juce::Graphics &g) override
            {
                if (m_dropY >= 0)
                {
                    ...
                    triangle.addTriangle(
                        float(getWidth()), float(m_dropY), float(getWidth() - 8), float(m_dropY - 4), float(getWidth() - 8), float(m_dropY + 4));
                    g.fillPath(triangle);
                }
            }
        ...
        class ScalableTableListBox : public juce::TableListBox, public juce::DragAndDropTarget
        {
        public:
            ...
            DropIndicatorOverlay &getDropOverlay()
            {
        ...
        class DataViewComponent : public juce::Component, public juce::DragAndDropContainer, private juce::TableListBoxModel, private juce::Timer
        {
        public:
