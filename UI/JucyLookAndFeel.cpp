...
namespace jucyaudio
{
    namespace ui
    {
        void JucyLookAndFeel::drawToggleButton(juce::Graphics &g, juce::ToggleButton &button, bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
        {
            juce::ignoreUnused(shouldDrawButtonAsHighlighted, shouldDrawButtonAsDown);

            spdlog::debug("JucyLookAndFeel::drawToggleButton called for: {}", button.getButtonText().toStdString());
            ...
            g.drawFittedText(
                button.getButtonText(), static_cast<int>(textX), 0, static_cast<int>(textWidth), button.getHeight(), juce::Justification::centredLeft, 2);
        }
    } // namespace ui
} // namespace jucyaudio