...
namespace jucyaudio::ui
{
    ...
    */
    class VirtualTimelineComponent : public juce::Component, public juce::AsyncUpdater, public juce::ChangeListener
    {
    public:
        using TrackId = int;
        ...
        struct WaveformKey
        {
            ...
            bool operator==(const WaveformKey &other) const
            {
                ...
                return trackId == other.trackId && tileIndex == other.tileIndex && isStereo == other.isStereo;
            }
        };
        ...
        struct WaveformKeyHash
        {
            ...
            {
                return std::hash<int>{}(key.trackId) ^ (std::hash<int>{}(key.tileIndex) << 1) ^ (std::hash<bool>{}(key.isStereo) << 2);
            }
        };
        ...
        //==============================================================================
        VirtualTimelineComponent(juce::AudioFormatManager &formatManager, juce::AudioThumbnailCache &thumbnailCache);
        ...
        const PerfMetrics &getMetrics() const
        {
            return metrics_;
        }
