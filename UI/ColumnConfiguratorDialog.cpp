...
void ColumnConfigurationDialogComponent::resized() {
    ...
    sideButtonsBox.items.add(juce::FlexItem(m_moveUpButton).withHeight(buttonHeight).withWidth(buttonWidth).withMargin(juce::FlexItem::Margin(0,0,5,5)));
    sideButtonsBox.items.add(juce::FlexItem(m_moveDownButton).withHeight(buttonHeight).withWidth(buttonWidth).withMargin(juce::FlexItem::Margin(0,0,0,5)));
    ...
    bottomButtonsBox.items.add(juce::FlexItem(m_resetButton).withHeight(buttonHeight).withWidth(buttonWidth).withMargin(juce::FlexItem::Margin(0,5,0,0)));
    bottomButtonsBox.items.add(juce::FlexItem(m_cancelButton).withHeight(buttonHeight).withWidth(buttonWidth).withMargin(juce::FlexItem::Margin(0,5,0,0)));
    bottomButtonsBox.items.add(juce::FlexItem(m_okButton).withHeight(buttonHeight).withWidth(buttonWidth).withMargin(juce::FlexItem::Margin(0,0,0,0))); // OK on far right
...
void ColumnConfigurationDialogComponent::buttonClicked(juce::Button* button) {
    if (button == &m_okButton) {
        ...
        if (m_onConfiguredCallback) m_onConfiguredCallback(false); // No changes applied
...
void ColumnConfigurationDialogComponent::paintListBoxItem(int rowNumber, juce::Graphics& g,
    ...
    juce::LookAndFeel::getDefaultLookAndFeel().drawTickBox(g, *this, 
                                                           checkboxBounds.getX(), checkboxBounds.getY(),
                                                           checkboxBounds.getWidth(), checkboxBounds.getHeight(),
                                                           colState.isVisible, 
                                                           true, // isEnabled
                                                           false, // isMouseOver
                                                           false); // isMouseDown
    ...
    g.drawText(colState.originalDataColumn->name, checkboxBounds.getRight() + 5, 0,
               width - (checkboxBounds.getRight() + 10), height,
...
void ColumnConfigurationDialogComponent::applyChanges() {
    ...
    if (m_onConfiguredCallback) m_onConfiguredCallback(true); // Signal changes were made
}
