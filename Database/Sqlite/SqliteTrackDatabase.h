...
namespace jucyaudio
{
    namespace database
    {
        ...
        public:
            ...
            DbResult deleteTracksFromLibrary(const std::vector<TrackId> &trackIds) override;
            ...
            IMixMarkerManager &getMixMarkerManager() override;
            const IMixMarkerManager &getMixMarkerManager() const override;
