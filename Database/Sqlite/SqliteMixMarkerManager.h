...
namespace jucyaudio::database
{
    ...
    {
    public:
        SqliteMixMarkerManager(SqliteDatabase& db) : m_db{db} {}
        ...
        std::optional<MixMarker> findMarkerNearPosition(MixId mixId, std::chrono::milliseconds position, std::chrono::milliseconds tolerance) const override;
