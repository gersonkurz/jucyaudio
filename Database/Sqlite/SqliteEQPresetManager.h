...
namespace jucyaudio
{
    namespace database
    {
        class SqliteEQPresetManager final : public IEQPresetManager
        {
        public:
            ...
            std::optional<model::EQPreset> savePreset(const juce::String &name, const audio::model::EQSettings &settings) override;
