...
namespace jucyaudio
{
    namespace database
    {
        ...
        std::optional<MixMarker> SqliteMixMarkerManager::findMarkerNearPosition(
            MixId mixId, std::chrono::milliseconds position, std::chrono::milliseconds tolerance) const
        {
